...
public interface UpdateMemberPort {
     ...
     */
    void updateMember(Long memberId, String newName, String newHashedPassword, String timezone, Integer dailyResetHour);
    void updateMemberRole(Long memberId, MemberRole role);
}
